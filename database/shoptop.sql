...
CREATE TABLE `boards` (
  ...
  `name_hy` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metatitle_hy` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadescription_hy` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metatitle_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadescription_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_ru` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metatitle_ru` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadescription_ru` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `publish` tinyint(4) NOT NULL DEFAULT 1,
  `parmalink` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `boards` (`id`, `image`, `preview`, `author_id`, `last_editor_id`, `category_id`, `sorting`, `created_at`, `updated_at`, `name_hy`, `metatitle_hy`, `metadescription_hy`, `name_en`, `metatitle_en`, `metadescription_en`, `name_ru`, `metatitle_ru`, `metadescription_ru`, `publish`, `parmalink`) VALUES
(1, '1584432401.jpg', 'preview_1584432401.jpg', 1, NULL, 45, 35, '2020-03-01 15:01:10', '2020-03-01 15:01:20', 'Մսամթերք', NULL, NULL, 'Meat Products', NULL, NULL, 'Мясные продукты', NULL, NULL, 1, NULL);
...
CREATE TABLE `categories` (
  ...
  `name_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `text_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metatitle_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metadescription_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `name_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `text_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metatitle_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metadescription_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `name_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `text_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metatitle_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metadescription_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `currency` (`id`, `country`, `code`, `symbol`, `name`) VALUES
(1, NULL, 'ALL', 'Lek', 'Leke'),
(2, 'USA', 'USD', '$', 'Dollars'),
(3, NULL, 'AFN', '؋', 'Afghanis'),
(4, NULL, 'ARS', '$', 'Pesos'),
(5, NULL, 'AWG', 'ƒ', 'Guilders'),
(6, NULL, 'AUD', '$', 'Dollars'),
(7, NULL, 'AZN', 'ман', 'New Manats'),
(8, NULL, 'BSD', '$', 'Dollars'),
(9, NULL, 'BBD', '$', 'Dollars'),
(10, NULL, 'BYR', 'p.', 'Rubles'),
(11, NULL, 'EUR', '€', 'Euro'),
(12, NULL, 'BZD', 'BZ$', 'Dollars'),
(13, NULL, 'BMD', '$', 'Dollars'),
(14, NULL, 'BOB', '$b', 'Bolivianos'),
(15, NULL, 'BAM', 'KM', 'Convertible Marka'),
(16, NULL, 'BWP', 'P', 'Pula'),
(17, NULL, 'BGN', 'лв', 'Leva'),
(18, NULL, 'BRL', 'R$', 'Reais'),
(19, NULL, 'GBP', '£', 'Pounds'),
...
(23, NULL, 'KYD', '$', 'Dollars'),
(24, NULL, 'CLP', '$', 'Pesos'),
(25, NULL, 'CNY', '¥', 'Yuan Renminbi'),
(26, NULL, 'COP', '$', 'Pesos'),
(27, NULL, 'CRC', '₡', 'Colón'),
(28, NULL, 'HRK', 'kn', 'Kuna'),
(29, NULL, 'CUP', '₱', 'Pesos'),
(30, NULL, 'CZK', 'Kč', 'Koruny'),
(31, NULL, 'DKK', 'kr', 'Kroner'),
(32, NULL, 'DOP ', 'RD$', 'Pesos'),
(33, NULL, 'XCD', '$', 'Dollars'),
(34, NULL, 'EGP', '£', 'Pounds'),
(35, NULL, 'SVC', '$', 'Colones'),
(36, NULL, 'FKP', '£', 'Pounds'),
...
(38, NULL, 'GHC', '¢', 'Cedis'),
(39, NULL, 'GIP', '£', 'Pounds'),
(40, NULL, 'GTQ', 'Q', 'Quetzales'),
(41, NULL, 'GGP', '£', 'Pounds'),
(42, NULL, 'GYD', '$', 'Dollars'),
(43, NULL, 'HNL', 'L', 'Lempiras'),
(44, NULL, 'HKD', '$', 'Dollars'),
(45, NULL, 'HUF', 'Ft', 'Forint'),
(46, NULL, 'ISK', 'kr', 'Kronur'),
(47, NULL, 'IDR', 'Rp', 'Rupiahs'),
(48, NULL, 'IRR', '﷼', 'Rials'),
(49, NULL, 'IMP', '£', 'Pounds'),
(50, NULL, 'ILS', '₪', 'New Shekels'),
(51, NULL, 'JMD', 'J$', 'Dollars'),
(52, NULL, 'JPY', '¥', 'Yen'),
(53, NULL, 'JEP', '£', 'Pounds'),
(54, NULL, 'KZT', 'лв', 'Tenge'),
(55, NULL, 'KPW', '₩', 'Won'),
(56, NULL, 'KRW', '₩', 'Won'),
(57, NULL, 'KGS', 'лв', 'Soms'),
(58, NULL, 'LAK', '₭', 'Kips'),
...
(60, NULL, 'LBP', '£', 'Pounds'),
(61, NULL, 'LRD', '$', 'Dollars'),
(62, NULL, 'CHF', 'CHF', 'Switzerland Francs'),
(63, NULL, 'LTL', 'Lt', 'Litai'),
(64, NULL, 'MKD', 'ден', 'Denars'),
(65, NULL, 'MYR', 'RM', 'Ringgits'),
(66, NULL, 'MUR', '₨', 'Rupees'),
(67, NULL, 'MXN', '$', 'Pesos'),
(68, NULL, 'MNT', '₮', 'Tugriks'),
(69, NULL, 'MZN', 'MT', 'Meticais'),
(70, NULL, 'NAD', '$', 'Dollars'),
(71, NULL, 'NPR', '₨', 'Rupees'),
(72, NULL, 'ANG', 'ƒ', 'Guilders'),
(73, NULL, 'NZD', '$', 'Dollars'),
(74, NULL, 'NIO', 'C$', 'Cordobas'),
(75, NULL, 'NGN', '₦', 'Nairas'),
(76, NULL, 'NOK', 'kr', 'Krone'),
(77, NULL, 'OMR', '﷼', 'Rials'),
(78, NULL, 'PKR', '₨', 'Rupees'),
(79, NULL, 'PAB', 'B/.', 'Balboa'),
(80, NULL, 'PYG', 'Gs', 'Guarani'),
(81, NULL, 'PEN', 'S/.', 'Nuevos Soles'),
(82, NULL, 'PHP', 'Php', 'Pesos'),
(83, NULL, 'PLN', 'zł', 'Zlotych'),
(84, NULL, 'QAR', '﷼', 'Rials'),
(85, NULL, 'RON', 'lei', 'New Lei'),
(86, 'Russia', 'RUB', 'руб', 'Rubles'),
(87, NULL, 'SHP', '£', 'Pounds'),
(88, NULL, 'SAR', '﷼', 'Riyals'),
(89, NULL, 'RSD', 'Дин.', 'Dinars'),
(90, NULL, 'SCR', '₨', 'Rupees'),
(91, NULL, 'SGD', '$', 'Dollars'),
(92, NULL, 'SBD', '$', 'Dollars'),
(93, NULL, 'SOS', 'S', 'Shillings'),
(94, NULL, 'ZAR', 'R', 'Rand'),
(95, NULL, 'LKR', '₨', 'Rupees'),
(96, NULL, 'SEK', 'kr', 'Kronor'),
(97, NULL, 'SRD', '$', 'Dollars'),
(98, NULL, 'SYP', '£', 'Pounds'),
(99, NULL, 'TWD', 'NT$', 'New Dollars'),
(100, NULL, 'THB', '฿', 'Baht'),
(101, NULL, 'TTD', 'TT$', 'Dollars'),
(102, NULL, 'TRY', '₺', 'Lira'),
(103, NULL, 'TRL', '£', 'Liras'),
(104, NULL, 'TVD', '$', 'Dollars'),
(105, NULL, 'UAH', '₴', 'Hryvnia'),
(106, NULL, 'UYU', '$U', 'Pesos'),
(107, NULL, 'UZS', 'лв', 'Sums'),
(108, NULL, 'VEF', 'Bs', 'Bolivares Fuertes'),
(109, NULL, 'VND', '₫', 'Dong'),
(110, NULL, 'YER', '﷼', 'Rials'),
(111, NULL, 'ZWD', 'Z$', 'Zimbabwe Dollars'),
(112, NULL, 'INR', '₹', 'Rupees'),
(113, NULL, 'AED', 'د.إ', 'UAE Dirham'),
(114, 'Armenia', 'AMD', 'Դ', 'Armenian Dram'),
(115, NULL, 'AOA', 'Kz', 'Kwanza'),
(116, NULL, 'BDT', '৳', 'Taka'),
(117, NULL, 'BHD', 'ب.د', 'Bahraini Dinar'),
(118, NULL, 'BIF', '₣', 'Burundi Franc'),
(119, NULL, 'BTN', '', 'Ngultrum'),
(120, 'Belarus', 'BYN', 'Br', 'Belarusian Ruble'),
(121, NULL, 'CDF', '₣', 'Congolese Franc'),
(122, NULL, 'CVE', '$', 'Cape Verde Escudo'),
(123, NULL, 'DJF', '₣', 'Djibouti Franc'),
(124, NULL, 'DZD', 'د.ج', 'Algerian Dinar'),
(125, NULL, 'ERN', 'Nfk', 'Nakfa'),
(126, NULL, 'ETB', '', 'Ethiopian Birr'),
(127, NULL, 'GEL', 'ლ', 'Lari'),
(128, NULL, 'GHS', '₵', 'Cedi'),
(129, NULL, 'GMD', 'D', 'Dalasi'),
(130, NULL, 'GNF', '₣', 'Guinea Franc'),
(131, NULL, 'HTG', 'G', 'Gourde'),
(132, NULL, 'IQD', 'ع.د', 'Iraqi Dinar'),
(133, NULL, 'JOD', 'د.ا', 'Jordanian Dinar'),
(134, NULL, 'KES', 'Sh', 'Kenyan Shilling'),
(135, NULL, 'KWD', 'د.ك', 'Kuwaiti Dinar'),
(136, NULL, 'LSL', 'L', 'Loti'),
(137, NULL, 'LYD', 'ل.د', 'Libyan Dinar'),
(138, NULL, 'MAD', 'د.م.', 'Moroccan Dirham'),
(139, NULL, 'MDL', 'L', 'Moldovan Leu'),
(140, NULL, 'MGA', '', 'Malagasy Ariary'),
(141, NULL, 'MMK', 'K', 'Kyat'),
(142, NULL, 'MOP', 'P', 'Pataca'),
(143, NULL, 'MRU', 'UM', 'Ouguiya'),
(144, NULL, 'MVR', 'ރ.', 'Rufiyaa'),
(145, NULL, 'MWK', 'MK', 'Kwacha'),
(146, NULL, 'PGK', 'K', 'Kina'),
(147, NULL, 'RWF', '₣', 'Rwanda Franc'),
(148, NULL, 'SDG', '£', 'Sudanese Pound'),
(149, NULL, 'SLL', 'Le', 'Leone'),
(150, NULL, 'STN', 'Db', 'Dobra'),
(151, NULL, 'SZL', 'L', 'Lilangeni'),
(152, NULL, 'TJS', 'ЅМ', 'Somoni'),
(153, NULL, 'TMT', 'm', 'Manat'),
(154, NULL, 'TND', 'د.ت', 'Tunisian Dinar'),
(155, NULL, 'TOP', 'T$', 'Pa’anga'),
(156, NULL, 'TZS', 'Sh', 'Tanzanian Shilling'),
(157, NULL, 'UGX', 'Sh', 'Uganda Shilling'),
(158, NULL, 'VUV', 'Vt', 'Vatu'),
(159, NULL, 'WST', 'T', 'Tala'),
(160, NULL, 'XAF', '₣', 'CFA Franc BCEAO'),
(161, NULL, 'XPF', '₣', 'CFP Franc'),
(162, NULL, 'ZMW', 'ZK', 'Zambian Kwacha'),
(163, NULL, 'XDR', '', 'Special Drawing Rights'),
(164, NULL, 'XOF', 'CFA', 'West African CFA franc'),
(165, NULL, 'VES', 'Bs', 'Venezuelan bolívar'),
(166, NULL, 'SSP', '£', 'South Sudanese pound'),
(167, NULL, 'KMF', 'CF', 'Comorian franc');
...
CREATE TABLE `settings` (
  ...
  `newemail` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `sitename_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metatitle_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metadescription_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `sitename_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metatitle_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metadescription_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `sitename_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metatitle_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `metadescription_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `cartempty_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `cartempty_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `cartempty_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertext_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertext_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertext_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertextcompleted_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertextcompleted_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertextcompleted_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `registertext_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `registertext_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `registertext_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `registercompletedtext_hy` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `registercompletedtext_ru` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `registercompletedtext_en` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_en` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_hy` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_ru` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
